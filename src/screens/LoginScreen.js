...
class LoginScreen extends React.Component {
  constructor(props) {
    ...
    GoogleSignin.configure({ webClientId: "854291224952-gcq02oqi708apd8v44fbeho0hiflag2r.apps.googleusercontent.com" });
  }
  ...
  render() {
    return (
      <View style={styles.container}>
        <Text style={[styles.title, styles.leftTitle]}>Entrar</Text>
